//! Modern search results cache implementation using the generic LRU framework
...
/// Modern search results cache type alias
pub type ModernSearchCache = LruCache<String, CardSearchResult, SearchJsonStorage>;

/// Create a new modern search results cache with sensible defaults
pub fn create_search_cache() -> Result<ModernSearchCache, ProxyError> {
...
/// Create a new modern search results cache with custom configuration
pub fn create_search_cache_with_config(
    cache_file: PathBuf,
    max_searches: usize,
) -> Result<ModernSearchCache, ProxyError> {
    let storage = SearchJsonStorage::new(cache_file, SEARCH_RESULT_SIZE_ESTIMATE)?;
...
mod tests {
    ...
    #[test]
    fn test_modern_search_cache_basic() {
    ...
    #[test]
    fn test_modern_search_cache_entry_limit() {
        let temp_file = env::temp_dir().join(format!(
    ...
    #[test]
    fn test_modern_search_cache_persistence() {
        let temp_file = env::temp_dir().join(format!(
